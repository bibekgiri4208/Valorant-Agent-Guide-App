...
import 'package:valorant_guide_app/data/guide_data.dart';
import 'package:valorant_guide_app/theme/app_colors.dart';

class GuidesScreen extends StatefulWidget {
  final double bottomOverlayHeight;
  const GuidesScreen({super.key, this.bottomOverlayHeight = 0});
...
class _GuidesScreenState extends State<GuidesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredGuides = guidesData.where((guide) {
...
class _GuideCard extends StatefulWidget {
  ...
  const _GuideCard({required this.item, required this.index, this.skipInitialAnim = false});

  @override
  State<_GuideCard> createState() => _GuideCardState();
}

class _GuideCardState extends State<_GuideCard> with SingleTickerProviderStateMixin {
